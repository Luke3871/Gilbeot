import svgPaths from "./svg-s7nii99nwf";
import imgFreeIconHeavyRain75125171 from "figma:asset/fce20544b46886313762578b47d2089e417d5c88.png";
...
function Component1() {
  return (
    <div className="absolute bg-[#a2cba1] h-[82px] left-[calc(50%-2.3px)] rounded-[15px] top-[166px] translate-x-[-50%] w-[347px]" data-name="위험요소 알림">
      ...
      <div className="absolute flex flex-col font-['Nunito:Medium',_'Noto_Sans_KR:Medium',_sans-serif] font-medium h-[18px] justify-center leading-[28px] left-[59px] text-[18px] text-white top-[42px] translate-y-[-50%] w-[297px]">
        <p className="mb-0">날씨가 추워 길이 미끄러우니</p>
        <p>미끄럽지 않은 길을 추천드려요.</p>
      </div>
...
function Component2() {
  return (
    <div className="absolute contents left-[75px] top-[116px]" data-name="시간 거리">
      <p className="absolute font-['Noto_Sans:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[25px] left-[calc(50%-60.3px)] text-[#6a7282] text-[18px] text-center text-nowrap top-[119px] tracking-[-1.5px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        22분
      </p>
      <p className="absolute font-['Noto_Sans:Regular',_sans-serif] font-normal leading-[25px] left-[calc(50%+18.2px)] text-[#6a7282] text-[18px] text-nowrap top-[119px] tracking-[-1.5px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        2.8km
      </p>
...
function Component4() {
  return (
    <div className="absolute h-[729.6px] left-[9px] top-0 w-[383.6px]" data-name="안전 경로">
      <div className="absolute bg-white h-[729.6px] left-0 top-0 w-[383.6px]" data-name="bg" />
      <Component1 />
      <Component2 />
      ...
      <p className="absolute font-['Noto_Sans:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[25px] left-[calc(50%-116.8px)] text-[#6a7282] text-[30px] top-[41px] tracking-[-1.5px] w-[117px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        안전 경로
      </p>
      <Component3 />
...
export default function Component6() {
  return (
    <div className="relative size-full" data-name="안전 경로 - 한파">
