import svgPaths from "./svg-i4m1szwsk7";
...
function WeatherDetailDialog6() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[50px] items-center left-[21px] top-[44px] w-[271px]" data-name="WeatherDetailDialog">
      <div className="relative shrink-0 size-[64px]" data-name="free-icon-sun-14322201 1">
        <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgFreeIconSun143222011} />
...
export default function Component22() {
  return (
    <div className="bg-white relative rounded-[30px] size-full" data-name="상세 날씨 정보 -맑음">
