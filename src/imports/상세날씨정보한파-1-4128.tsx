import svgPaths from "./svg-vfmp5ekpih";
    ...
    <div className="h-[31px] relative shrink-0 w-[400.8px]" data-name="WeatherDetailDialog">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[31px] relative w-[400.8px]">
        <div className="absolute font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[29.25px] left-0 text-[18px] text-nowrap text-white top-[-21px] whitespace-pre">
          <p className="mb-0">체온 유지에 신경 쓰세요.</p>
...
function Component8() {
  return (
    <div className="absolute bg-[#a2cba1] box-border content-stretch flex flex-col gap-[36px] h-[138px] items-start left-[28px] pl-[24px] pr-0 py-[24px] rounded-[16px] top-[706px] w-[327px]" data-name="건강 정보">
  ...
  return (
    <div className="absolute h-[40px] left-0 top-0 w-[112.65px]" data-name="Container">
      <p className="absolute font-['Nunito:Medium',_sans-serif] font-medium leading-[40px] left-0 text-[#6a7282] text-[36px] top-[-0.8px] w-[57px]">
        <span className="text-[#145ec9]">-9</span>°
      </p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute content-stretch flex h-[28px] items-start left-0 top-[44px] w-[112.65px]" data-name="Container">
      <p className="basis-0 font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal grow leading-[28px] min-h-px min-w-px relative shrink-0 text-[#364153] text-[20px]">한파</p>
    </div>
  );
}
...
function WeatherDetailDialog6() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[50px] items-center left-[21px] top-[44px] w-[271px]" data-name="WeatherDetailDialog">
      <div className="relative shrink-0 size-[52px]" data-name="free-icon-thermometer-10043898 1">
        <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgFreeIconThermometer100438981} />
...
function Text1() {
  return (
    <div className="h-[28px] relative shrink-0 w-[104.938px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[28px] relative w-[104.938px]">
        <p className="absolute font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[28px] left-0 text-[#364153] text-[18px] top-0 w-[135px]">체감온도 -12°</p>
      </div>
    </div>
  );
}
...
function WeatherDetailDialog9() {
  return (
    <div className="h-[31px] relative shrink-0 w-[303px]" data-name="WeatherDetailDialog">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[31px] relative w-[303px]">
        <div className="absolute font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[29.25px] left-0 text-[18px] text-nowrap text-white top-[-21px] whitespace-pre">
          <p className="mb-0">두꺼운 외투, 목도리, 장갑 등</p>
          <p>방한 준비가 필요해요</p>
        </div>
      </div>
    </div>
...
function Component18() {
  return (
    <div className="absolute bg-[#a2cba1] box-border content-stretch flex flex-col gap-[36px] h-[139px] items-start left-[28px] pl-[24px] pr-0 py-[24px] rounded-[16px] top-[554px] w-[327px]" data-name="옷차림 추천">
...
export default function Component21() {
  return (
    <div className="bg-white relative rounded-[30px] size-full" data-name="상세 날씨 정보 - 한파">
