import svgPaths from "./svg-rnawp6xb36";
...
function Component() {
  return (
    <div className="absolute contents left-[31px] top-[197px]" data-name="출발지">
      ...
      <p className="absolute font-['Noto_Sans:Regular',_'Noto_Sans_Symbols2:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal h-[27px] leading-[25px] left-[calc(50%-161px)] text-[#6a7282] text-[24px] top-[197px] tracking-[-1.5px] w-[175px] whitespace-pre-wrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
...
function Component1() {
  return (
    <div className="absolute contents left-[31px] top-[340px]" data-name="도착지">
      ...
      <p className="absolute font-['Noto_Sans:Regular',_'Noto_Sans_Symbols2:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal h-[27px] leading-[25px] left-[calc(50%-161px)] text-[#6a7282] text-[24px] top-[340px] tracking-[-1.5px] w-[175px] whitespace-pre-wrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
...
function Component4() {
  return (
    <div className="absolute contents left-[31px] top-[482px]" data-name="최근 검색">
      ...
      <p className="absolute font-['Noto_Sans:Regular',_'Noto_Sans_Symbols2:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal h-[11.364px] leading-[25px] left-[52px] text-[#6a7282] text-[0px] text-[18px] top-[537px] tracking-[-1.5px] w-[171px] whitespace-pre-wrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        <span className="text-[#967c58]">●</span> 월곡사회복지관
      </p>
      <p className="absolute font-['Noto_Sans:Regular',_'Noto_Sans_Symbols2:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal h-[11.364px] leading-[25px] left-[52px] text-[#6a7282] text-[0px] text-[18px] top-[584px] tracking-[-1.5px] w-[109px] whitespace-pre-wrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
