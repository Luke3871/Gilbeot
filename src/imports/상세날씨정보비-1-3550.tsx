import svgPaths from "./svg-0mqva5rcqn";
    ...
    <div className="h-[31px] relative shrink-0 w-[400.8px]" data-name="WeatherDetailDialog">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[31px] relative w-[400.8px]">
        <div className="absolute font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[29.25px] left-0 text-[18px] text-nowrap text-white top-[-21px] whitespace-pre">
          <p className="mb-0">외출하기 좋은 날씨예요</p>
          <p className="mb-0">적당한 운동도 좋습니다.</p>
          <p>&nbsp;</p>
        </div>
      </div>
    </div>
...
function Component8() {
  return (
    <div className="absolute bg-[#a2cba1] box-border content-stretch flex flex-col gap-[36px] h-[145px] items-start left-[26.2px] pl-[24px] pr-0 py-[24px] rounded-[16px] top-[693px] w-[327px]" data-name="건강 정보">
...
function Container5() {
  return (
    <div className="absolute content-stretch flex h-[28px] items-start left-0 top-[44px] w-[112.65px]" data-name="Container">
      <p className="basis-0 font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal grow leading-[28px] min-h-px min-w-px relative shrink-0 text-[#364153] text-[20px]">비</p>
    </div>
  );
}
...
function WeatherDetailDialog6() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[50px] items-center left-[21px] top-[44px] w-[271px]" data-name="WeatherDetailDialog">
      <div className="relative shrink-0 size-[65px]" data-name="free-icon-rainy-4837807 1">
        <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgFreeIconRainy48378071} />
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border size-[65px]" />
      </div>
      <Container7 />
    </div>
  );
...
function WeatherDetailDialog9() {
  return (
    <div className="h-[31px] relative shrink-0 w-[303px]" data-name="WeatherDetailDialog">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[31px] relative w-[303px]">
        <p className="absolute font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[29.25px] left-0 text-[18px] text-nowrap text-white top-[-21px] whitespace-pre">외출치 우산을 꼭 챙기세요.</p>
      </div>
    </div>
  );
}
...
function WeatherDetailDialog10() {
  return (
    <div className="h-[28px] relative shrink-0 w-[274px]" data-name="WeatherDetailDialog">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[28px] relative w-[274px]">
        <Icon6 />
...
function WeatherDetailDialog11() {
  return (
    <div className="h-[31px] relative shrink-0 w-[400.8px]" data-name="WeatherDetailDialog">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[31px] relative w-[400.8px]">
        <div className="absolute font-['Nunito:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[29.25px] left-0 text-[18px] text-nowrap text-white top-[-21px] whitespace-pre">
          <p className="mb-0">습도가 높아 불쾌지수가 오를 수 있어요.</p>
          <p>통풍이 잘되는 옷이 좋아요.</p>
        </div>
      </div>
    </div>
...
function Component19() {
  return (
    <div className="absolute bg-[#a2cba1] box-border content-stretch flex flex-col gap-[36px] h-[145px] items-start left-[26.2px] pl-[24px] pr-0 py-[24px] rounded-[16px] top-[693px] w-[327px]" data-name="건강 정보">
      <WeatherDetailDialog10 />
      <WeatherDetailDialog11 />
    </div>
  );
}
...
export default function Component22() {
  return (
    <div className="bg-white relative rounded-[30px] size-full" data-name="상세 날씨 정보 - 비">
